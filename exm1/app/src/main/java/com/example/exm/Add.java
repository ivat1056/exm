    ...
    public  void postData()
    {
        ...
        call.enqueue(new Callback<Model>() {
            ...
            public void onResponse(Call<Model> call, Response<Model> response) {
                ...
                {
                    Toast.makeText(Add.this, "При добавление возникла ошибка", Toast.LENGTH_SHORT).show();
                }
                Toast.makeText(Add.this, "Данные успешно добавились в базу данных", Toast.LENGTH_SHORT).show();
            }
